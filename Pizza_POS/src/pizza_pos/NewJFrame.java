...
public class NewJFrame extends javax.swing.JFrame {
 ...
 public void bill_print(){
        ...
        try {
            bill.setText("               IEGCODE E-COMMERCE \n");
            bill.setText(bill.getText() + "\tSleman, Yogyakarta \n");
            bill.setText(bill.getText() + "\t+62 85876076005 \n");
            ...
            bill.setText(bill.getText() + "----------------------------------------------------------------\n");
            bill.setText(bill.getText() +"                  made with \uD83D\uDC99 iegcode"+"\n");
